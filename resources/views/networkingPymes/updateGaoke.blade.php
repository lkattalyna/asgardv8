...
@section('content_header')
    <h1> Formulario de ejecución actualización de los equipos gaoke</h1><hr>
@stop
...
@section('content')
    @can('networking-pymes-run')
        ...
        <form action="{{ route('networkingPymes.updateGaokeStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución actualización de los equipos gaoke</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td>
                                <label for="host">{{ __('Router') }}</label>
                            </td>
                            <td>
                                <div class="input-group">
