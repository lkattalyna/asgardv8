...
@section('content_header')
    <h1> Formulario de ejecución reinicio de los equipos gaoke</h1><hr>
@stop
...
@section('content')
    @can('networking-pymes-run')
        ...
        <form action="{{ route('networkingPymes.restartGaokeStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución reinicio de los equipos gaoke</h3>
                </div>
                <div class="card-body">
