...
@section('content_header')
    <h1> Formulario para gestión de snapshot</h1><hr>
@stop
...
@section('content')
    @can('unixEN-run')
        ...
        <form action="{{ route('unix.snapSolarisStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario para gestión de snapshot</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="pool" id="pool" class="form-control input-md" value="{{ old('pool') }}" maxlength="100"
                                        pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,100}" placeholder="Separe los pool con ':'" required>
                            </td>
                        </tr>
                    </table>
                </div>
