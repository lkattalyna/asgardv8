...
@section('content_header')
    <h1> Formulario ejecución siete pasos y liberación memoria caché Unix</h1><hr>
@stop
...
@section('content')
    @can('unixEN-run')
        ...
        <form action="{{ route('unix.sevenStepsFreeMemoryStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title"> Formulario ejecución siete pasos y liberación memoria caché Unix</h3>
                </div>
                <div class="card-body">
