...
@section('content_header')
    <h1> Formulario Gestion De Servicios Unix</h1><hr>
@stop
...
@section('content')
    @can('unixEN-run')
        ...
        <form action="{{ route('unix.serviceManagementStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario Gestion De Servicios Unix</h3>
                </div>
                <div class="card-body">
