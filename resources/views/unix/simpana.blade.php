...
@section('content_header')
    <h1> Gestión Servicio Simpana</h1><hr>
@stop
...
@section('content')
    @can('unixEN-run')
        ...
        <form action="{{ route('unix.simpanaStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Gestión Servicio Simpana </h3>
                </div>
                <div class="card-body">
                            ...
                            <td>
                                <div class="input-group">
                                    <select name="option" id="option" class="form-control" required>
                                        ...
                                        <option value="restartInterface">Reiniciar Interface</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
