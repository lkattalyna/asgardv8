...
@section('content_header')
    <h1> Formulario de ejecución de post-ventana unix</h1><hr>
@stop
...
@section('content')
    @can('unixEN-run')
        ...
        <form action="{{ route('unix.pasoPosteriorStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución de post-ventana unix</h3>
                </div>
                <div class="card-body">
