...
@section('content_header')
    <h1> Formulario para listar información solaris</h1><hr>
@stop
...
@section('content')
    @can('unixEN-run')
        ...
        <form action="{{ route('unix.snapSListStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario para listar información solaris </h3>
                </div>
                <div class="card-body">
                            ...
                            <td>
                                <div class="input-group">
                                    <select name="action" id="action" class="form-control" required>
                                        ...
                                        <option value="Listar Pool">Listar Pool</option>
                                        <option value="Listar Snapshots">Listar Snapshots</option>
                                        <option value="Listar ZFS">Listar ZFS</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
