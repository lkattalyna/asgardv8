...
@section('content')
    @can('menu-create')
        ...
        <form action="{{route('admin.menus.createWithAutoPOST') }}" method="post">
            {!! csrf_field() !!}
            <div class="card card-default">
                ...
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <th>
                                <label for="url" class="text-md-right">Sistema operativo</label>
                            </th>
                            <td>                            
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    ...
                                    <select class="form-control" onchange="cambiarAutos(this)" name="so" id="so" required>
                                        <option value="" disabled selected>Seleccionar...</option>
                                        @foreach($contextSO as $so)
                                            <option value="{{ $so['value'] }}">{{ $so['tag'] }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <tr>
                            <th>
                                <label for="url" class="text-md-right">Automatización</label>
                            </th>
                            <td>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    ...
                                    <select class="form-control" name="automatizacion" id="automatizacion" required></select>
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" name="inventario" id="inventario">
                                @foreach($inventarios as $inventario)
                                    <option value="{{$inventario->id_inventory}}">{{$inventario->id_inventory}} - {{$inventario->name_inventory}}</option>
                                @endforeach
                            </select>
...
@stop
@section('js')
    @include('admin.viewMenu.scriptsWithAuto')
@endsection
