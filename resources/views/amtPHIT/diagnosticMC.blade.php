...
@section('content_header')
    <h1> Formulario revisión memoria y cpu</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPHIT.diagnosticMCStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario revisión memoria y cpu</h3>
                </div>
                <div class="card-body">
