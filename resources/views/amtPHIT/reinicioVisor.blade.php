...
@section('content_header')
    <h1> Formulario de reinicio Visor</h1><hr>
@stop
...
@section('content')
    @can('amtPHIT-run')
        ...
        <form action="{{ route('amtPHIT.reinicioVisorStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de reinicio Visor</h3>
                </div>
                <div class="card-body">
