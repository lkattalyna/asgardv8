...
@section('content_header')
    <h1> Formulario De Validación NFS Servidores Venecia</h1><hr>
@stop
...
@section('content')
    @can('unixPH-run')
        ...
        <form action="{{ route('unixPH.validationNFSVeneciaStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario De Validación NFS Servidores Venecia</h3>
                </div>
                <div class="card-body">
