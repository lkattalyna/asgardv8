...
@section('content_header')
    <h1> Formulario Ejecución Bash SUN </h1><hr>
@stop
...
@section('content')
    @can('unixPH-run')
        ...
        <form action="{{ route('unixPH.UpBashYamlSUNStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario Ejecución Bash SUN</h3>
                </div>
                <div class="card-body">
