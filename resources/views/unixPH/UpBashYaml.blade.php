...
@section('content_header')
    <h1> Formulario Ejecución Bash UnixPH </h1><hr>
@stop
...
@section('content')
    @can('unixPH-run')
        ...
        <form action="{{ route('unixPH.UpBashYamlStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario Ejecución Bash UnixPH</h3>
                </div>
                <div class="card-body">
