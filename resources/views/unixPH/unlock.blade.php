...
@section('content_header')
    <h1> Formulario de Desbloqueo de usuarios P&H</h1><hr>
@stop
...
@section('content')
    @can('unixPH-run')
        ...
        <form action="{{ route('unixPH.unlockStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de Desbloque de usuarios</h3>
                </div>
                <div class="card-body">
