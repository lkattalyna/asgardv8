...
@section('content_header')
    <h1>Formulario De Prevalidación Reinicio Unix</h1><hr>
@stop
...
@section('content')
    ...
    <form action="{{ route('unixPH.prevalidationStore') }}" method="post" id="formfield">
        {!! csrf_field() !!}
        <div class="card card-default">
            <div class="card-header with-border">
                <h3 class="card-title">Prevalidación Reinicio Unix</h3>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        <td>
                            <label for="case">{{ __('Caso Service Manager') }}</label>
                        </td>
                        <td>
