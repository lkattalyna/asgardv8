...
@section('content_header')
    <h1> Formulario de ejecución de estadísticas de los datasources</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.estDataSourceStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución de estadísticas de los datasources</h3>
                </div>
                <div class="card-body">
