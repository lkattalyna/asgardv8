...
@section('content_header')
    <h1> Formulario de ejecución de reinicio escalonado</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.reinicioEscalonadoStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución de reinicio escalonado</h3>
                </div>
                <div class="card-body">
