...
@section('content_header')
    <h1> Formulario de Reinicio Cluster EAP FULFILLOPER</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.reinicioClusterEAPStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de Reinicio Cluster EAP FULFILLOPER</h3>
                </div>
                <div class="card-body">
