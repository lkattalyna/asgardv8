...
@section('content_header')
    <h1> Formulario Subir Procesos Cloud y Java Triara</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.upCloudTriaraStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario Subir Procesos Cloud y Java Triara</h3>
                </div>
                <div class="card-body">
