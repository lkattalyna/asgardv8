...
@section('content_header')
    <h1> Formulario Subida del Sistema Itel Aprov Triara</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.ITELTriaraAprovUpStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario Subida del Sistema Itel Aprov Triara</h3>
                </div>
                <div class="card-body">
