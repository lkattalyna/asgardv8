...
@section('content_header')
    <h1> Formulario de ejecución de reinicio co_datoscomp_wls_pr</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.reinicioDatosCompStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución de reinicio co_datoscomp_wls_pr</h3>
                </div>
                <div class="card-body">
