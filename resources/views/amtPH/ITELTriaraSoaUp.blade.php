...
@section('content_header')
    <h1> Formulario subida Itel Soa Triara</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.ITELTriaraSoaUpStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario subida Itel Soa Triara</h3>
                </div>
                <div class="card-body">
