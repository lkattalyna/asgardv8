...
@section('content_header')
    <h1> Formulario Baja CO_EOCECM_WLS_PR</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.InspEocecmBajarStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario Baja CO_EOCECM_WLS_PR</h3>
                </div>
                <div class="card-body">
