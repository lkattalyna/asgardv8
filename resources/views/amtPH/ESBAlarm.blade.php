...
@section('content_header')
    <h1> Formulario Envío Correo Manejado ESB con Hilos</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.ESBAlarmStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario Envío Correo Manejado ESB con Hilos</h3>
                </div>
                <div class="card-body">
