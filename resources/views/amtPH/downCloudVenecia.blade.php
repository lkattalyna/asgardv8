...
@section('content_header')
    <h1> Formulario Bajar Procesos Cloud y Java Venecia</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.downCloudVeneciaStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario Bajar Procesos Cloud y Java Venecia</h3>
                </div>
                <div class="card-body">
