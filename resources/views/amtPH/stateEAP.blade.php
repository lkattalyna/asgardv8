...
@section('content_header')
    <h1> Formulario Consulta por Nodo Manager del estado Dominios EAP</h1><hr>
@stop
...
@section('content')
    @can('amtPH-run')
        ...
        <form action="{{ route('amtPH.stateEAPStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de Consulta por Nodo Manager EAP</h3>
                </div>
                <div class="card-body">
