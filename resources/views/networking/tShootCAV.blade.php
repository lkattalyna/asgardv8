...
@section('content_header')
    <h1> Formulario de ejecución T-SHOOT general para CAV'S</h1><hr>
@stop
...
@section('content')
    @can('networking-run')
        ...
        <form action="{{ route('networking.tShootCAVStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución de T-SHOOT general para CAV'S</h3>
                </div>
                <div class="card-body">
