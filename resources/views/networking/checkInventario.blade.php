...
@section('content_header')
    <h1> Formulario de ejecución de check de inventario</h1><hr>
@stop
...
@section('content')
    @can('networking-run')
        ...
        <form action="{{ route('networking.checkInventarioStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución de check de inventario</h3>
                </div>
                <div class="card-body">
