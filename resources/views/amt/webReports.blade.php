...
@section('content_header')
    <h1> Formulario de reporte weblogic</h1><hr>
@stop
...
@section('content')
    @can('amt-run')
        ...
        <form action="{{ route('amt.webReportsStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de reporte weblogic</h3>
                </div>
                <div class="card-body">
