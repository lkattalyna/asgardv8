...
@section('content_header')
    <h1> Formulario de check paso a operación tomcat</h1><hr>
@stop
...
@section('content')
    @can('amt-run')
        ...
        <form action="{{ route('amt.checkPasoTomcatStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de check paso a operación tomcat</h3>
                </div>
                <div class="card-body" id="parsed_csv_list">
                    <table class="table table-bordered table-hover">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="path" id="path" class="form-control input-md" value="{{ old('path') }}" maxlength="250"
                                           pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{3,}" placeholder="/etc/" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
