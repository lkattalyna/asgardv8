...
@section('content_header')
    <h1 class="content-max-width">Discos del servidor</h1>
    <hr>
@stop
@section('content')
    @can('recursos-run')
    ...
    <form action="{{ route('discos.store', $server->id) }}" method="POST" class="form-horizontal">
        {!! csrf_field() !!}
        <div class="card card-default">
            <div class="card-header with-border">
                <h3 class="card-title">Formulario de asignación de  discos al servidor</h3>
            </div>
            <div class="card-body">
