...
@section('content_header')
    <h1 class="content-max-width">Creación Data Center</h1>
    <hr>
@stop
...
@section('content')
    ...
    <form action="{{ route('dataCenter.store') }}" method="POST" class="form-horizontal">
        {!! csrf_field() !!}
        <div class="card card-default">
            <div class="card-header with-border">
                <h3 class="card-title">Formulario de creación de data center</h3>
            </div>
            <div class="card-body">
