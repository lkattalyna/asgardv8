...
@section('content_header')
    <h1> Formulario de deshabilitación de usuarios</h1><hr>
@stop
...
@section('content')
    @can('supportEN-run')
        ...
        <form action="{{ route('supportEN.disableUserStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de deshabilitación de usuarios</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td>
                                <label for="status">{{ __('Habilitar / Deshabilitar') }}</label>
                            </td>
                            <td>
                                <div class="input-group">
                                    <select name="status" id="status" class="form-control" style="width: 100%" required>
                                        <option value="" disabled selected>--Seleccione--</option>
                                        <option value="false">Habilitar</option>
