...
@section('content_header')
    <h1> Formulario de depuración de memoria windows</h1><hr>
@stop
...
@section('content')
    @can('supportEN-run')
        ...
        <form action="{{ route('supportEN.freeMemoryStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de depuración de memoria windows</h3>
                </div>
                <div class="card-body">
