...
@section('content_header')
    <h1> Formulario para depuración de discos windows</h1><hr>
@stop
...
@section('content')
    @can('supportEN-run')
        ...
        <form action="{{ route('supportEN.debuggingDisks') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario para depuración de discos windows</h3>
                </div>
                <div class="card-body">
