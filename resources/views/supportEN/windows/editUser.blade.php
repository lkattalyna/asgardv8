...
@section('content_header')
    <h1> Formulario de modificación de usuarios</h1><hr>
@stop
...
@section('content')
    @can('supportEN-run')
        ...
        <form action="{{ route('supportEN.editUserStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control input-md" value="{{ old('name') }}" maxlength="150"
                                        pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,30}$" placeholder="Nombre Completo" required>
                                </div>
                            </td>
                        </tr>
                        <tr>
