...
@section('content_header')
    <h1> Formulario de listado de puertos abiertos unix</h1><hr>
@stop
...
@section('content')
    @can('supportEN-run')
        ...
        <form action="{{ route('supportEN.unix.portListenStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de listado de puertos abiertos unix</h3>
                </div>
                <div class="card-body">
