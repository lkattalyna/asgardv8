...
@section('content')
    @can('windowsEN-run')
        ...
        <form action="{{ route('windows.serviceManagementStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
...
@section('js')
    ...
    function consultarServicios() {
        ...
        $.ajax({
            url: "{{route('pass.windows.getServicesByHost')}}",
            type: 'post',
            data: parametros,
            ...
            for( let servicio of servicios ){
                html+=`
                    <tr>
                        ...
                        <td><button onclick='cambiarEstado("${servicio.Name}","listar")'>Listar</button></td>
                    </tr>
                `;
            }
            tableServicios.innerHTML= html;
