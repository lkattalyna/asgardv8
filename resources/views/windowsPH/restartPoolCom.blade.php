...
@section('content_header')
    <h1> Formulario de ejecución de reinicio Application Pool Comcel</h1><hr>
@stop
...
@section('content')
    @can('windowsPH-run')
        ...
        <form action="{{ route('windowsPH.restartPoolComStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución de de reinicio Application Pool Comcel</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td>
                                <label for="pool">{{ __('Nombre del Application Pool') }}</label>
                            </td>
                            <td>
                                <div class="input-group">
                                    ...
                                    <input type="text" name="pool" id="pool" class="form-control input-md" value="{{ old('pool') }}" maxlength="50"
                                        pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,50}$" placeholder="Pool" required>
                                </div>
                            </td>
                        </tr>
                    </table>
