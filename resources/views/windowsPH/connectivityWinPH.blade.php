...
@section('content_header')
    <h1> Formulario Conectividad Windows P&H</h1><hr>
@stop
...
@section('content')
    @can('windowsPH-run')
        ...
        {{-- {{ route('windowsPH.connectivityPHStore') }} --}}
        <form action="{{ route('windowsPH.connectivityPHStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
