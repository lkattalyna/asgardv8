...
@section('content_header')
    <h1> Formulario de ejecución de reporte sitios web y pools</h1><hr>
@stop
...
@section('content')
    @can('windowsPH-run')
        ...
        <form action="{{ route('windowsPH.reportSWPStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución de reporte sitios web y pools</h3>
                </div>
                <div class="card-body">
