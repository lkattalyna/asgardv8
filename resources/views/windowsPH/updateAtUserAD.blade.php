...
@section('content_header')
    <h1> Formulario de actualización de atributos de usuarios AD</h1><hr>
@stop
...
@section('content')
    @can('windowsPH-run')
        ...
        <form action="{{ route('windowsPH.updateAtUserADStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de actualización de atributos de usuarios AD</h3>
                </div>
                <div class="card-body">
