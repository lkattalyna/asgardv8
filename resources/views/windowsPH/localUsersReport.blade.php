...
@section('content_header')
    <h1> Formulario de reporte de usuarios locales<h1><hr>
@stop
...
@section('content')
    @can('windowsPH-run')
        ...
        <form action="{{ route('windowsPH.localUsersReportStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de reporte de usuarios locales</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" name="case" id="case" class="form-control input-md" value="{{ old('case') }}" maxlength="50"
                                        pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,50}$" placeholder="Número de caso" required>
                                </div>
                            </td>
                        </tr>
                    </table>
