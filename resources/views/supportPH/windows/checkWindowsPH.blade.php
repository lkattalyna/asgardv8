...
@section('content_header')
    <h1> Formulario de ejecución check soporte windows</h1><hr>
@stop
...
@section('content')
    @can('supportPH-run')
        ...
        <form action="{{ route('supportPH.checkWindowsPHStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución check soporte windows</h3>
                </div>
                <div class="card-body">
