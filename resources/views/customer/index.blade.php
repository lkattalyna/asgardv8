                        ...
                        @foreach ($Customer as $customer)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('customer.customerCluster', $customer->customerID) }}"
                                        title="Segregar por cluster">
                                        <button class="btn btn-sm btn-default">
                                            <i class="fa fa-users" style="color: #0d6aad"></i>
                                        </button>
                                    </a>
                                    </a>
                                    <a href="{{ route('customer.customerDictionary', $customer->customerID) }}"
                                        title="Segregación por Diccionario">
                                        <button class="btn btn-sm btn-default">
                                ...
                                <td class="center">
                                    ...
                                    <a href="#" title="Eliminar"
                                        data-href="{{ route('customer.destroy', $customer->customerID) }}" data-toggle="modal"
