            ...
            <div class="card card-default">
                ...
                <div class="card-body" style="width: 25%;">
                    ...
                    <div id="cluster-container">
                        @if ($customerDictionaries === null || $customerDictionaries->isEmpty() ||
                        count($customerDictionaries) == 0)
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="valores_agregados[][visible]"
                                id="{{ $customerDictionary->value }}" value="{{ $customerDictionary->value }}" disabled>
            ...
            <tr>
                ...
                <td>
                    <div class="input-group">
                        ...
                        <button class="btn btn-sm btn-danger ml-2"><i class="fa fa-plus"></i> Agregar</button>
                    </div>
                </td>
            </tr>
        </table>
