...
<!-- encabezado seccion para agregar valores TFM agregados -->
<div class="card-header with-border" style="background: #dfe1e4;">
    <h3 class="card-title">TFM Agregados</h3>
</div>
<div class="card card-default">
    <div class="card-body">
        <form id="formulario_Dictionary" method="POST"
            ...
            <div id="Dictionary-container" style="width: 25%;">
                ...
                @if ($customerDictionaries === null || $customerDictionaries->isEmpty() || count($customerDictionaries)
                == 0)
                ...
                <div class="input-group mb-2" id="val-{{ $customerDictionary->customerdictionaryID }}">
                    ...
                    <input class="form-control" name="valores_agregados[]" value="{{ $customerDictionary->value }}"
                        disabled />
                    <button class="btn btn-sm btn-danger ml-2" type="button"
                        onclick="eliminarValor(event, 'val-{{ $customerDictionary->customerdictionaryID }}')">Eliminar</button>
                </div>
                @endforeach
                @endif
            </div>
