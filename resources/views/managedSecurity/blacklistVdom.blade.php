...
@section('content_header')
    <h1> Formulario de blacklist firewall con vdom</h1><hr>
@stop
        ...
        <form enctype="multipart/form-data" action="{{ route('managedSecurity.blacklistNotVdomStore') }}" method="post" id="formfield">
            ...
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de blacklist firewall con vdom</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <th>
                                <label for="vdom" class="text-md-right">Digite el vdom</label>
                            </th>
                            <td>
                                <div class="input-group">
                                    <input type="text" name="vdom" id="vdom" class="form-control" value="{{ old('vdom') }}"
                                        placeholder="Ingrese manualmente el VDOM" required>
                                </div>
                            </td>
                        </tr>
                        <tr>
