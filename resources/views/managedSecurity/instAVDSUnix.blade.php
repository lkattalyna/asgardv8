...
@section('content_header')
    <h1> Formulario de instalación AV DS Unix</h1><hr>
@stop
...
@section('content')
    @can('ManagedSecurity-run')
        ...
        <form action="{{ route('managedSecurity.instAVDSUnixStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de instalación AV DS Unix</h3>
                </div>
                <div class="card-body">
