...
@section('content_header')
    <h1> Formulario de instalación AV DS Windows</h1><hr>
@stop
...
@section('content')
    @can('ManagedSecurity-run')
        ...
        <form action="{{ route('managedSecurity.instAVDSWinStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de instalación AV DS Windows</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td>
                                <label for="op">Opción</label>
                            </td>
                            <td>
                                <div class="input-group">
                                    <select name="op" id="op" class="form-control" required>
                                        <option selected disabled>-- Seleccione --</option>
                                        <option value="Con_Proxy">Con Proxy</option>
                                        <option value="Sin_Proxy">Sin Proxy</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
