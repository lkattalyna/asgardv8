...
@section('content_header')
    <h1>Formulario de paso a operación VM</h1><hr>
@stop
...
@section('content')
    @can('virtualization-run')
        <form action="{{ route('virtualization.operationStepStore') }}" method="POST" id="formfield">
            {{ csrf_field() }}
            <div class="card card-default">
                ...
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        <tr>
                            <td>
                                <label for="vHost">{{ __('Virtual Machine') }}</label>
                            </td>
                            <td>
