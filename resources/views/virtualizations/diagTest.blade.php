...
@section('content_header')
    <h1>Formulario pruebas asgard new ansible</h1><hr>
@stop
...
@section('content')
    ...
    @include('layouts.messages')
        <form action="{{ route('virtualization.diagTestStore') }}" method="POST" id="formfield">
            {{ csrf_field() }}
            <div class="card card-default">
                <div class="card-header with-border" style="background: #dfe1e4;">
                    <h3 class="card-title">Formulario pruebas asgard new ansible </h3>
                </div>
                <div class="card-body">
