            ...
            @foreach($hosts as $host)
                <tr>
                    ...
                    <td style="text-align:center; ">
                        <a href="#" title="Ejecutar Diagnostico" class="Vlink" data-id="{{ $host->vm_id }}" data-vcenter="{{ $host->vcenter }}" data-name="{{ $host->name }}"  data-memory="{{ $host->memory }}" data-cpu="{{ $host->cpu }}" data-power_state="{{ $host->power_state }}">
