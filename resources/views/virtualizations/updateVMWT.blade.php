...
@section('content_header')
    <h1>Formulario de actualización de VmWare Tools</h1><hr>
@stop
...
@section('content')
    @can('virtualization-run')
        <form action="{{ route('virtualization.updateVMWTStore') }}" method="POST" id="formfield">
            {{ csrf_field() }}
            <div class="card card-default">
                <div class="card-header with-border" style="background: #dfe1e4;">
                    <h3 class="card-title">Datos para la actualización de VmWare Tools</h3>
                </div>
                <div class="card-body">
