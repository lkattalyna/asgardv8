...
@section('content_header')
    <h1>Formulario de borrado de snapshots</h1><hr>
@stop
...
@section('content')
    @can('virtualization-run')
        <form action="{{ route('virtualization.snapDeleteStore') }}" method="POST" id="formfield">
            {{ csrf_field() }}
            <div class="card card-default">
                <div class="card-header with-border" style="background: #dfe1e4;">
                    <h3 class="card-title">Datos para el borrado del snapshot</h3>
                </div>
                <div class="card-body">
