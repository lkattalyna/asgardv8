...
@section('content_header')
    <h1>Reporte de NIC virtual hosts</h1><hr>
@stop
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="card-title">NIC's de virtual hosts registrados en el sistema</h3>
        ...
        <div class="card-body">
            ...
            <table id="example1" class="table table-striped table-bordered" >
                ...
                <tbody>
                    @foreach($vmNics as $vmNic)
                        <tr>
                            <td>{{ $vmNic->vmHost->name }}</td>
                            <td>{{ $vmNic->vmHost->cluster }}</td>
                            <td>{{ $vmNic->vmnic }}</td>
                            ...
                            <td style="text-align:center; ">
                                <a href="{{ route('virtualization.VMHostShow',$vmNic->id_vmhost) }}" target="_blank" title="Ver detalles">
