...
@section('content_header')
    <h1> Formulario de creación de NAS</h1><hr>
@stop
...
@section('content')
    @can('sanNas-create')
        ...
        <form action="{{ route('sanNas.store') }}" method="POST" class="form-horizontal">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de creación de NAS</h3>
                </div>
                <div class="card-body">
