...
@section('content_header')
    <h1> Formulario de creación de servidor</h1><hr>
@stop
...
@section('content')
    @can('sanServer-create')
        ...
        <form action="{{ route('sanServer.store') }}" method="POST" class="form-horizontal">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de creación de servidor</h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="name" name="name" type="text" maxlength="40"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,40}" required  value="{{ old('name') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="code" name="code" type="text" maxlength="30"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,30}" required  value="{{ old('code') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="serial" name="serial" type="text" maxlength="20"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,20}" required  value="{{ old('serial') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="so" name="so" type="text" maxlength="40"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,40}" required  value="{{ old('so') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="other" name="other" type="text" maxlength="64"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,64}" required value="N/A"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="location" name="location" type="text" maxlength="50"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,50}" required  value="{{ old('location') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="storage" name="storage" type="text" maxlength="50"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,50}" required value="N/A"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="memory" name="memory" type="text" maxlength="10"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,10}"  required value="N/A"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="info" name="info" maxlength="100"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,100}" required >N/A
                            </textarea>
                        </div>
                    </div>
                </div>
