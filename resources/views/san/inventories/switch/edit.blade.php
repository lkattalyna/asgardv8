...
@section('content_header')
    <h1> Formulario de edición de switch</h1><hr>
@stop
...
@section('content')
    @can('sanSwitch-edit')
        ...
        <form action="{{ route('sanSwitch.update', $sanSwitch->id) }}" method="POST" class="form-horizontal">
            {!! csrf_field() !!}
            @method('PUT')
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de edición de switch</h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="fabric" class="col-sm-2 control-label">Fabric al que pertenece:</label>
                        <div class="col-sm-10">
                            <input class="form-control" id="fabric" name="fabric" type="text" maxlength="20"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,50}" value="{{ $sanSwitch->fabric }}" readonly/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="name" name="name" type="text" maxlength="50"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,50}" value="{{ $sanSwitch->sw }}" readonly/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="ip"  class="col-sm-2 control-label">IP del switch</label>
                        <div class="col-sm-10">
                            <input type="text" name="ip" class="form-control" data-inputmask="'alias': 'ip'" data-mask="" im-insert="true" value="{{ $sanSwitch->ip }}" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="domain" name="domain" type="number"  placeholder="Si el Switch es Access Gateway escribir 0 (Cero)" min="0"
                                value="{{ $sanSwitch->domain }}" readonly/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="serial" name="serial" type="text" maxlength="25"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,25}" value="{{ $sanSwitch->serial }}" readonly/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="code" name="code" type="text" maxlength="20"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,20}" required  value="{{ $sanSwitch->code }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="maker" name="maker" type="text" maxlength="20"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,20}" required  value="{{ $sanSwitch->maker }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="model" class="col-sm-2 control-label">Modelo del switch:</label>
                        <div class="col-sm-10">
                            <input class="form-control" id="model" name="model" type="text" maxlength="20"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,20}" required  value="{{ $sanSwitch->model }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="support" class="col-sm-2 control-label">{{ __('Fecha soporte') }}</label>
                        <div class="col-sm-10">
                            <input type="text" name="support" id="support" class="form-control input-md" value="{{ $sanSwitch->support_date }}"
