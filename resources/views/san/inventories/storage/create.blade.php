...
@section('content_header')
    <h1> Formulario de creación de storage</h1><hr>
@stop
...
@section('content')
    @can('sanStorage-create')
        ...
        <form action="{{ route('sanStorage.store') }}" method="POST" class="form-horizontal">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de creación de storage</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="mark" name="mark" type="text" maxlength="20"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,20}" required  value="{{ old('mark') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="model" name="model" type="text" maxlength="35"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,35}" required  value="{{ old('model') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="type" name="type" type="text" maxlength="20"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,20}" required value="N/A"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="location" name="location" type="text" maxlength="30"
                                pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,30}" required  value="{{ old('location') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
