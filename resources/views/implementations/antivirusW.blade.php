...
@section('content_header')
    <h1> Formulario de instalación de antivirus windows</h1><hr>
@stop
...
@section('content')
    @can('implementation-run')
        ...
        <form action="{{ route('implementations.antivirusWStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de instalación de antivirus windows</h3>
                </div>
