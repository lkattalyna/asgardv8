...
@section('content_header')
    <h1> Formulario de licenciamiento windows</h1><hr>
@stop
...
@section('content')
    @can('implementation-run')
        ...
        <form action="{{ route('implementations.licenciamientoWStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de licenciamiento windows</h3>
                </div>
                <div class="card-body">
