...
@section('content_header')
    <h1> Formulario de creación de tareas de desarrollo</h1><hr>
@stop
@section('content')
    @can('devTask-create')
        ...
        <form action="{{route('devTasks.store') }}" method="post">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de creación de tareas de desarrollo</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="min" id="min" class="form-control" value="{{ old('min') }}" placeholder="Tiempo en minutos" required>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="number" name="max" id="max" class="form-control" value="{{ old('max') }}" placeholder="Tiempo en minutos" required>
                            </td>
                        </tr>
                        <tr>
                            <th>
