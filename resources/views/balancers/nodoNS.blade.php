...
@section('content_header')
    <h1> Formulario de ejecución nodo NS</h1><hr>
@stop
...
@section('content')
    @can('balancer-run')
        ...
        <form action="{{ route('balancers.nodoNSStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de ejecución nodo NS</h3>
                </div>
                <div class="card-body">
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control input-md" value="{{ old('name') }}" maxlength="50"
                                           pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,}" placeholder="Name" required>
                                </div>
                            </td>
                        </tr>
                        <tr>
