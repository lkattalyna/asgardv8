...
@section('content_header')
    <h1> Formulario de habilitación/deshabilitación de member en grupo servicio NS</h1><hr>
@stop
...
@section('content')
    @can('balancer-run')
        ...
        <form action="{{ route('balancers.grupoServicioNSStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de habilitación/deshabilitación de member en grupo servicio NS</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td>
                                <label for="nserver">{{ __('Servidor') }}</label>
                            </td>
                            <td>
