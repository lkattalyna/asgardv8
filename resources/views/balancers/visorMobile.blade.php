...
@section('content_header')
    <h1> Información Servicios Visor Mobile</h1><hr>
@stop
...
@section('content')
    @can('balancer-run')
        ...
        <form action="{{ route('balancers.visorMobileStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de servicios visor mobile</h3>
                </div>
                <div class="card-body">
