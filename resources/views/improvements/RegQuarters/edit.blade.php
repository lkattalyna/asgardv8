...
@section('content_header')
    <h1> Formulario de edición de periodos</h1><hr>
@stop
...
@section('content')
    @can('regQuarter-edit')
        ...
        <form action="{{ route('RegQuarters.update', $RegQuarter->id) }}" method="POST" class="form-horizontal">
            {!! csrf_field() !!}
            @method('PUT')
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de edición de periodos</h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="name" name="name" type="text" maxlength="50"
                                   pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,50}" required  value="{{ $RegQuarter->name }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" name="start" id="start" class="form-control input-md" value="{{ $RegQuarter->start_date }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" name="end" id="end" class="form-control input-md" value="{{ $RegQuarter->end_date }}"
                                   pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" readonly required>
                            </div>
                        </div>
                    </div>
