                        ...
                        <td>
                            ...
                            @if (request()->has('segment'))
                                <select class="form-control" name="segment" id="segment" style="width: 100%;" disabled>
                                    <option value="{{ $segments->where('id', request()->get('segment'))->first()->id }}"
                                        selected>
                            ...
                            <td>
                                @if (request()->has('service_layer'))
                                    <select class="form-control" name="layer" id="layer" style="width: 100%;" required
                                        disabled>
                                        <option value="{{ $layers->where('id', request()->get('service_layer'))->first()->id }}"
                                            selected>
                            ...
                            <td>
                                <div class="input-group">
                                    @if (request()->has('description'))
                                        <textarea name="description" id="description" class="form-control" placeholder="Descripcion" maxlength="200"
                                            rows="2" required disabled>{{ request()->get('description') }}</textarea>
                                        <div class="input-group-append">
                                            <span class="input-group-text" data-toggle="popover" data-html="true"
                                                data-placement="left" title="Ayuda"
                                                data-content="Por favor proporcione una breve descripción de la automatización a publicar.">
                            ...
                            <td>
                                <div class="input-group">
                                    @if (request()->has('scope'))
                                        <textarea name="scope" id="scope" class="form-control" placeholder="Alcance" maxlength="200" rows="2"
                                            required disabled>{{ request()->get('scope') }}</textarea>
                                        <div class="input-group-append">
                                            <span class="input-group-text" data-toggle="popover" data-html="true"
                                                data-placement="left" title="Ayuda"
                                                data-content="Por favor consigne claramente el alcance y/o limitaciones de la automatización a publicar.">
                                                <i class="fas fa-question-circle"></i>
                                            </span>
                                        </div>
                                        <!-- Campo oculto para enviar el valor -->
                            ...
                            <td>
                                <div class="input-group">
                                    @if (request()->has('objetive'))
                                        <textarea name="objetive" id="objetive" class="form-control" placeholder="Objetivo" maxlength="200"
                                            rows="2" required disabled>{{ request()->get('objetive') }}</textarea>
                                        <div class="input-group-append">
                                            <span class="input-group-text" data-toggle="popover" data-html="true"
                                                data-placement="left" title="Ayuda"
                                                data-content="Por favor ingrese el objetivo fundamental de la automatización a publicar.">
                                                <i class="fas fa-question-circle"></i>
                                            </span>
                                        </div>
                                        <!-- Campo oculto para enviar el valor -->
                                    ...
                                    @else
                                        <textarea name="objetive" id="objetive" class="form-control" placeholder="Objetivo" maxlength="200"
                                            rows="2" required>{{ old('objetive') }}</textarea>
                                        <div class="input-group-append">
                                            <span class="input-group-text" data-toggle="popover" data-html="true"
                                                data-placement="left" title="Ayuda"
                                                data-content="Por favor ingrese el objetivo fundamental de la automatización a publicar.">
                            ...
                            <td>
                                @if (request()->has('aut_type'))
                                    ...
                                    <select class="form-control" name="tAut" id="tAut" style="width: 100%;" required
                                        disabled>
                                        <option value="Acción" @if ($autType == 'Administrativa') selected @endif>Acción
                                        </option>
                                        <option value="Consulta" @if ($autType == 'Consulta') selected @endif>Consulta
                                        </option>
                                    </select>
                                    <!-- Campo oculto para enviar el valor -->
                                    <input type="hidden" name="tAut" value="{{ $autType }}">
                                @else
                                    <select class="form-control" name="tAut" id="tAut" style="width: 100%;"
                                        required>
                                        <option></option>
                            ...
                            <td>
                                @if (request()->has('task_type'))
                                    ...
                                    <select class="form-control" name="task" id="task" style="width: 100%;" required
                                        disabled>
                                        <option value="Administrativa" @if ($taskType == 'Administrativa') selected @endif>
                                            Administrativa</option>
                                        <option value="Implementación" @if ($taskType == 'Implementación') selected @endif>
                                            Implementación</option>
                                        <option value="Operativa" @if ($taskType == 'Operativa') selected @endif>Operativa
                                        </option>
                                    </select>
                                    <!-- Campo oculto para enviar el valor -->
                ...
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" name="deliverable" id="deliverable" class="form-control"
                                        value="{{ old('deliverable') }}" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{1,80}"
                                        placeholder="Reporte" maxlength="80" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text" data-toggle="popover" data-html="true"
                                            data-placement="left" title="Ayuda" data-content="PDF, Script, Reporte">
                                            <i class="fas fa-question-circle"></i>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="input-group">
                                    <div class="input-group-append">
                                        <span class="input-group-text" data-toggle="popover" data-html="true"
                                            data-placement="left" title="Ayuda"
                                            data-content="Si esta es una automatización que pertenece a otra, se debe seleccionar la automatización padre,
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" name="name" id="name" class="form-control"
                                        value="{{ old('name') }}" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-].{11,31}"
                                        placeholder="UNX_PH_001_TEST" maxlength="31" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text" data-toggle="popover" data-html="true"
                                            data-placement="left" title="Ayuda"
                                            data-content="Segmentos : </br>TR = Transversal </br>EN = Empresas y Negocios </br>PH = Personas y Hogares
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="number" name="fq" id="fq" min="1" max="32767"
                                        class="form-control" value="{{ old('fq') }}" placeholder="0" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text" data-toggle="popover" data-html="true"
                                            data-placement="left" title="Ayuda"
                                            data-content="Ingrese el número de ejecuciones de la automatización en la frecuencia escogida.">
                                            <i class="fas fa-question-circle"></i>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="input-group">
                                    <div class="input-group-append">
                                        <span class="input-group-text" data-toggle="popover" data-html="true"
                                            data-placement="left" title="Ayuda"
                                            data-content="Nivel de los responsables actuales de la ejecución de la tarea">
                                            <i class="fas fa-question-circle"></i>
                                        </span>
                                    </div>
                                    <select class="form-control select2" name="customerLevel" id="customerLevel"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="number" name="minB" id="minB" min="1" max="32767"
                                        class="form-control" value="{{ old('minB') }}" placeholder="25" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text" data-toggle="popover" data-html="true"
                                            data-placement="left" title="Ayuda"
                                            data-content="Ingrese el tiempo en minutos que lleva actualmente realizar el proceso que se busca automatizar, este tiempo debe ser respeto a 1 (un) CI">
                                            <i class="fas fa-question-circle"></i>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="number" name="minA" id="minA" min="1" max="32767"
                                        class="form-control" value="{{ old('minA') }}" placeholder="25" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text" data-toggle="popover" data-html="true"
                                            data-placement="left" title="Ayuda"
                                            data-content="Ingrese el tiempo en minutos que tomaría realizar el proceso después de automatizar, este tiempo debe ser respeto a 1 (un) CI">
                                            <i class="fas fa-question-circle"></i>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="number" name="min" id="min" min="1" max="32767"
                                        class="form-control" value="{{ old('min') }}" readonly required>
                                    <div class="input-group-append">
                                        <span class="input-group-text" data-toggle="popover" data-html="true"
                                            data-placement="left" title="Ayuda"
                                            data-content="Tiempo en minutos que optimizará la automatización">
                                            <i class="fas fa-question-circle"></i>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="input-group">
                                    <div class="input-group-append">
                                        <span class="input-group-text" data-toggle="popover" data-html="true"
                                            data-placement="left" title="Ayuda"
                                            data-content="Nivel de los responsables de la ejecución de la tarea una vez la automatización este finalizada">
                                            <i class="fas fa-question-circle"></i>
                                        </span>
                                    </div>
                                    <select class="form-control" name="customerLevelPost" id="customerLevelPost"
                                        style="width: 50%;" required>
                                        <option></option>
                                        @foreach ($levels as $level)
                                            <option value="{{ $level->id }}">{{ $level->name }}</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="number" name="goal" id="goal" min="1" max="32767"
                                        class="form-control" value="{{ old('goal') }}" placeholder="25" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text" data-toggle="popover" data-html="true"
                                            data-placement="left" title="Ayuda"
                                            data-content="Ingrese el número de CI's que afectara esta automatización">
                                            <i class="fas fa-question-circle"></i>
                                        </span>
                                    </div>
                                </div>
