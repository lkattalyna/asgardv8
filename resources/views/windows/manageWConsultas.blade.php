...
@section('content_header')
    <h1> Formulario de gestión stop start wconsultas<h1><hr>
@stop
...
@section('content')
    @can('windowsEN-admin')
        ...
        <form action="{{ route('windows.manageWConsultasStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de gestión stop start wconsultas</h3>
                </div>
                <div class="card-body">
                            ...
                            <td>
                                <div class="input-group">
                                    <select name="option" id="option" class="form-control" style="width: 100%" required>
                                        <option></option>
                                        <option value="Stop_apppool">Detener</option>
                                        <option value="Start_apppool">Iniciar</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
