...
@section('content_header')
    <h1> Formulario de Verificación Porcentaje de Uso en Disco</h1><hr>
@stop
...
@section('content')
    @can('windowsEN-run')
        ...
        <form action="{{ route('windows.diskCheckStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de Verificación Porcentaje de Uso en Disco</h3>
                </div>
                <div class="card-body">
