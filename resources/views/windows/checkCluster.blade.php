...
@section('content_header')
    <h1> Formulario de check cluster windows</h1><hr>
@stop
...
@section('content')
    @can('windowsEN-run')
        ...
        <form action="{{ route('windows.checkCluster') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de check cluster windows</h3>
                </div>
                <div class="card-body">
