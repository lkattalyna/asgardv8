...
@section('content_header')
    <h1> Formulario de gestión stop start wcompensar<h1><hr>
@stop
...
@section('content')
    @can('windowsEN-admin')
        ...
        <form action="{{ route('windows.manageWCompensarStore') }}" method="post" id="formfield">
            {!! csrf_field() !!}
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">Formulario de gestión stop start wcompensar</h3>
                </div>
                <div class="card-body">
