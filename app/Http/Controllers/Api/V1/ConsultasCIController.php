...
class ConsultasCIController extends Controller
{
    public function store(Request $request)
    {
        ...
        if (!empty($idCliente)){
            $res = $client->request(
                'GET',
                "http://172.22.108.160:14081/SM/9/rest/devices?view=expand&query=ConfigurationItemType=\"computer\"%26UCMDBCompany=\"$idCliente\"%26NewUcmdb=true",
                [
